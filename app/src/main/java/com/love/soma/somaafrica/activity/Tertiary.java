...
public class Tertiary extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LocalBroadcastManager.getInstance(getActivity()).registerReceiver(mMessageReceiver, new IntentFilter("search_tertiary"));
        addsch();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.fragment_tertiary, container, false);
    ...
    private void addsch() {
        ...
        if(cursor == null){
            ...
            for (int i = 0; i < 7; i++) {
                ...
                String[] school = {"SomaAfrica University", "Anodel University", "Infants institute", "Kireka University", "Kibuli Technical College", "Kampala Parents Institute","Lubiri University"};
...
// Sets the values of each column and inserts the word.
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private Tertiary.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final Tertiary.ClickListener clickListener) {
