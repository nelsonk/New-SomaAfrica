...
public class Nursery extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LocalBroadcastManager.getInstance(getActivity()).registerReceiver(mMessageReceiver, new IntentFilter("search_nursery"));
        addsch();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.fragment_nursery, container, false);
        ...
        //recyclerView.addOnItemTouchListener(getActivity());
    ...
    private void addsch() {
        ...
        if(cursor == null){
            ...
            for (int i = 0; i < 7; i++) {
                ...
                String[] school = {"SomaAfrica Nursery School", "Anodel Nursery School", "Infants Kindergaten", "Kireka infants School", "Kibuli Nursery", "Kampala Nursery","Lubiri Nursery School"};
...
// Sets the values of each column and inserts the word.
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private Nursery.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final Nursery.ClickListener clickListener) {
